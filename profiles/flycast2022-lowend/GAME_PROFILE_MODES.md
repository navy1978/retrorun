...
| --- | --- | --- | --- | --- |
| Sonic Adventure 2 | `MK-51117`, `HDR-0165` | `fast_depth=menu_guarded_shadow_safe`, merge opachi disattivato | `fast_depth=menu_guarded_shadow_safe`, merge opachi attivato | Le varianti retail europea/nordamericana e giapponese condividono il profilo. La modalità prestazioni ha misurato 30,35 FPS contro 23,24 FPS (`+30,6%`) sullo stesso save-state RG351V, senza frame saltati; ombre, menu, audio e gioco sono stati approvati manualmente. |
...
| Soul Calibur | `T1401D  50`, `T1401M`, `T1401N` | `retrorun-soul-T1401D50.cfg` | `experimental/retrorun-soul-performance-T1401D50.cfg` | Le edizioni retail europea, giapponese e nordamericana usano lo stesso profilo. La variante validata usa `per_triangle` e corregge la barra energia. Quella veloce usa `top_hud_last` e ha misurato +16,79%, ma il fondale può occasionalmente apparire sopra la barra. |
