...
profile.MK-51049.best_validated.title = ChuChu Rocket (USA, baseline)
profile.MK-51049.best_performance.title = ChuChu Rocket (USA, initial baseline)
